...
${OBJ_DIR}/assg05-library.o: ${SRC_DIR}/assg05-library.cpp ${INC_DIR}/assg05-library.hpp
${OBJ_DIR}/${PROJECT_NAME}-tests.o: ${SRC_DIR}/${PROJECT_NAME}-tests.cpp ${INC_DIR}/assg05-library.hpp
